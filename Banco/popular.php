...
echo "<td><a href='popular.php?id=$arreglo[0]&idborrar=2'><img src='imagenes/tarjetaborrar.svg' width='60' class='img-rounded'/></a></td>";
        ...
        echo "</table>";
          ...
          if(@$idborrar==2){
            ...
            echo '<script>alert("EL SISTEMA A ELIMINADO A ESTE USUARIO")</script> ';
